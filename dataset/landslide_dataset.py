...
class LandslideDataSet(data.Dataset):
    def __init__(self, data_dir, list_path, max_iters=None, set="labeled"):
        ...
        print("Number of files loaded:", len(self.files))
...
if __name__ == "__main__":
    ...
    train_dataset = LandslideDataSet(
        data_dir="./dataset/", list_path="./dataset/train.txt"
    )
    ...
    test_list = "./dataset/test.txt"  # Path to test file list

    test_dataset = LandslideDataSet(
        data_dir="./dataset/", list_path=test_list, set="unlabeled"
    )
